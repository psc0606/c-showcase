...
void people(int a[19][19],int j,Node seat[290],int *n);						//人人对战移动光标

void computer(int a[19][19],int j,Node seat[290],int *n);					//人机对战移动光标
...
void set_chess_huifang(int i, int j, int n);
