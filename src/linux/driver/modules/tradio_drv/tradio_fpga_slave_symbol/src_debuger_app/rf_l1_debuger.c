...
#define JDMA_MAP_OUT_BOUND_5SUBFRAME_DATA_SIZE			(MAP_OUT_PER_SUBFRAME_20MHZ * 5)	 
...
#define JDMA_RX_SAMPLING_5SUBFRAME_DATA_SIZE			(TRANSMIT_PER_SUBFRAME_20MHZ * 5)
...
int main(int argc, char *argv[])
{
	...
	unsigned int iqcounter_handle=0;
	char jdma_tx_status;
	char jdma_rx_status;
	char is_loopback;
	int fd_rad;
	...
	while (1) {
		printf("1:Load Tx Test Vector	      2:Set Central Frequent Point\n");
		printf("3:Read IQ Counter 1 REGS	      4:Read IQ Counter 4 REGS\n");
		printf("5:PRINT 12ms CELL SEARCH DATA      \n");
		printf("6:PRINT DL SAMPLING 5subframe DATA  7:PRINT DL MAP OUT BOUND 5subframe DATA\n");
		printf("8:PRINT UL SAMPLING 5subframe DATA  9:PRINT UL MAP OUT BOUND 5subframe DATA\n");
		if (jdma_tx_status)
			printf("a:JDMA Tx STOP\n");
		else 
			printf("a:JDMA Tx START\n");
			
		if (jdma_rx_status)
			printf("b:JDMA Rx STOP\n");
		else 
			printf("b:JDMA Rx START\n");
		printf("c:Read JDMA REGS\n");
		printf("d:TEMP DATA\n");
		if(is_loopback)
		    printf("e:LOOPBACK OFF\n");
		else
		    printf("e:LOOPBACK ON\n");
		printf("f:PRINT 40ms CELL SEARCH DATA\n");
		printf("g:PRINT TOTAL_IQ_COUNTER\n");
		printf("h:CHANGE TYPE OF IQ COUNTER\n");
		printf("0:QUIT\n");
		do_what = getchar();
		getchar();
		switch (do_what){
		...
		break;
		case '2':
			scanf("%lf",&central_freq_point);
			getchar();
			printf("freq point %lf\n",central_freq_point);
			cfg9361_base_rx_freq(fd_spi,central_freq_point);
		break;
		case '3':
		...
		// break;
		case '5'://cell search 12subframe
			recv_addr = (short *)malloc(CELL_SEARCH_12SUBFRAME_DATA_BASEADDR_PHY_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_COPY_CELL_SEARCH_DATA_12,recv_addr);
			fprx = fopen("cell_search_12subframe_Iq_data","w+");
			...
			fclose(fprx);
		break;
		case 'z'://cell search 12subframe//葛老师专用
			recv_addr_gww = (char *)malloc(CELL_SEARCH_12SUBFRAME_DATA_BASEADDR_PHY_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_COPY_CELL_SEARCH_DATA_12,recv_addr_gww);
			fprx = fopen("cell_search_12subframe_Iq_data","w+");
			for (i = 0;i < CELL_SEARCH_12SUBFRAME_DATA_BASEADDR_PHY_SIZE;i++) {
				fprintf(fprx,"0x%02x\n",*(recv_addr_gww + i));
			}
			free(recv_addr_gww);
			fclose(fprx);
		break;
		case '6'://dl rx sampling 5subframe
			recv_addr = (short *)malloc(JDMA_RX_SAMPLING_5SUBFRAME_DATA_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_COPY_DL_JDMA_RX_SAMPLING_5SUBFRAME_DATA,recv_addr);
			fprx = fopen("dl_time_domain_5ms","w+");
			for (i = 0;i < JDMA_RX_SAMPLING_5SUBFRAME_DATA_SIZE / 2;i++) {
				fprintf(fprx,"%d\n",*(recv_addr + i));
			}
			free(recv_addr);
			fclose(fprx);
		break;
		case '7'://DL MAP OUTBOUND DATA
			recv_addr = (short *)malloc(JDMA_MAP_OUT_BOUND_5SUBFRAME_DATA_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_COPY_DL_MAP_OUTBOUNT_DATA,recv_addr);
			fprx = fopen("dl_freq_domain_5ms","w+");
			for (i = 0;i < JDMA_MAP_OUT_BOUND_5SUBFRAME_DATA_SIZE / 2;i++) {
				fprintf(fprx,"%d\n",*(recv_addr + i));
			}
			free(recv_addr);
			fclose(fprx);
		break;
		case '8'://ul rx sampling 5subframe
			recv_addr = (short *)malloc(JDMA_RX_SAMPLING_5SUBFRAME_DATA_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_COPY_UL_JDMA_RX_SAMPLING_5SUBFRAME_DATA,recv_addr);
			fprx = fopen("ul_time_domain_5ms","w+");
			for (i = 0;i < JDMA_RX_SAMPLING_5SUBFRAME_DATA_SIZE / 2;i++) {
				fprintf(fprx,"%d\n",*(recv_addr + i));
			}
			free(recv_addr);
			fclose(fprx);
		break;
		case '9'://UL MAP OUTBOUND DATA
			recv_addr = (short *)malloc(JDMA_MAP_OUT_BOUND_5SUBFRAME_DATA_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_COPY_UL_MAP_OUTBOUNT_DATA,recv_addr);
			fprx = fopen("ul_freq_domain_5ms","w+");
			for (i = 0;i < JDMA_MAP_OUT_BOUND_5SUBFRAME_DATA_SIZE / 2;i++) {
				fprintf(fprx,"%d\n",*(recv_addr + i));
			}
			free(recv_addr);
		...
		case 'c':
			...
			print_jdma_regs(&jdmaregs);
			ret = ioctl(fd_rad,TRAD_IOCTL_JDMA_UL_REGS , &jdma_map1_regs);
			print_jdma_map1_regs(&jdma_map1_regs);
		break;
		//dingchen
		case 'd'://TEMP DATA
			recv_addr = (unsigned short *)malloc(TEMP_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_TEMP,recv_addr);
			fprx = fopen("temp_data","w+");
		...
		break;
		case 'f'://cell search 40subframe
			recv_addr = (short *)malloc(CELL_SEARCH_40SUBFRAME_DATA_BASEADDR_PHY_SIZE);
			ret = ioctl(fd_rad,TRAD_IOCTL_COPY_CELL_SEARCH_DATA_40,recv_addr);
			fprx = fopen("cell_search_40subframe_Iq_data","w+");
		...
		break;
		case 'g'://TEMP DATA
			ret = ioctl(fd_rad,TRAD_IOCTL_TEMP,&FFIqCntCfg);
			print_iq_total_regs(&FFIqCntCfg);
		break;
		case 'h'://TEMP DATA
		    if(iqcounter_handle==0)
		    {
			iqcounter_handle = 1;
			ret = ioctl(fd_rad,TRAD_IOCTL_CHANGE_TEMP,&iqcounter_handle);
			printf("FSync Mode!\n");
		    }
		    else{
			iqcounter_handle = 0;
...
void print_jdma_map1_regs(PJDMA_MAP1 p_jdma_map1_regs)
{
	...
	printf("************JDMA0 PORT1 UL************\n");
	// printf("TxTemplate0.Desc0.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[0].TrSize);
	// printf("TxTemplate0.Desc0.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[0].TrCtrl);
	// printf("TxTemplate0.Desc0.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[0].SymOffset);
	// printf("TxTemplate0.Desc0.Res0      : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[0].Res0);
	// printf("TxTemplate0.Desc1.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[1].TrSize);
	// printf("TxTemplate0.Desc1.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[1].TrCtrl);
	// printf("TxTemplate0.Desc1.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[1].SymOffset);
	// printf("TxTemplate0.Desc1.Res0      : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[1].Res0);
	// printf("TxTemplate0.Desc2.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[2].TrSize);
	// printf("TxTemplate0.Desc2.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[2].TrCtrl);
	// printf("TxTemplate0.Desc2.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[2].SymOffset);
	// printf("TxTemplate0.Desc2.Res0      : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[2].Res0);
	// printf("TxTemplate0.Desc3.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[3].TrSize);
	// printf("TxTemplate0.Desc3.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[3].TrCtrl);
	// printf("TxTemplate0.Desc3.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate0.Desc[3].SymOffset);
	// printf("TxTemplate0.Desc3.Res0      : 0x%01x\n",jdma_map1_regs.TxTemplate0.Desc[3].Res0);
	// printf("TxTemplate1.Desc0.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[0].TrSize);
	// printf("TxTemplate1.Desc0.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate1.Desc[0].TrCtrl);
	// printf("TxTemplate1.Desc0.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[0].SymOffset);
	// printf("TxTemplate1.Desc0.Res0      : 0x%01x\n",jdma_map1_regs.TxTemplate1.Desc[0].Res0);
	// printf("TxTemplate1.Desc1.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[1].TrSize);
	// printf("TxTemplate1.Desc1.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate1.Desc[1].TrCtrl);
	// printf("TxTemplate1.Desc1.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[1].SymOffset);
	// printf("TxTemplate1.Desc1.Res0      : 0x%01x\n",jdma_map1_regs.TxTemplate1.Desc[1].Res0);
	// printf("TxTemplate1.Desc2.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[2].TrSize);
	// printf("TxTemplate1.Desc2.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate1.Desc[2].TrCtrl);
	// printf("TxTemplate1.Desc2.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[2].SymOffset);
	// printf("TxTemplate1.Desc2.Res0      : 0x%01x\n",jdma_map1_regs.TxTemplate1.Desc[2].Res0);
	// printf("TxTemplate1.Desc3.Trsize    : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[3].TrSize);
	// printf("TxTemplate1.Desc3.TrCtrl    : 0x%01x\n",jdma_map1_regs.TxTemplate1.Desc[3].TrCtrl);
	// printf("TxTemplate1.Desc3.SymOffset : 0x%04x\n",jdma_map1_regs.TxTemplate1.Desc[3].SymOffset);
	// printf("TxSymCtrl0.TslEntry0        : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.TslEntry[0]);
	// printf("TxSymCtrl0.TslEntry1        : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.TslEntry[1]);
	// printf("TxSymCtrl0.TslEntry2        : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.TslEntry[2]);
	// printf("TxSymCtrl0.TslEntry3        : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.TslEntry[3]);
	// printf("TxSymCtrl0.BasePtr          : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.BasePtr);
	// printf("TxSymCtrl0.CurSymBufPtr     : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.CurSymBufPtr);
	// printf("TxSymCtrl0.ShortStride      : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.ShortStride);
	// printf("TxSymCtrl0.LongStride       : 0x%08x\n",jdma_map1_regs.TxSymCtrl0.LongStride);
